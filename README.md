...
1. Fork this repo. Keep the repository name "cloudbees-core-minikube-lab".
1. Clone the repo from your fork:

```bash
git clone https://github.com/<your-github-username>/cloudbees-core-minikube-lab.git
```

2. Move into the directory:

```bash
cd cloudbees-core-minikube-lab
```
